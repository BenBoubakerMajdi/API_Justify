...
const checkRateLimit = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const user = yield User_1.default.findOne({ email }); // Find user by email
        if (!user) {
        ...
        yield user.save(); // Save updated user data
